...
const AboutMe = () => {
  return (
    <div id="about" className="container">
      ...
      {/* <div className="row stabout">
        <div className="col-lg-6">
          <h2>About Me</h2>
          <p>
            I am an allround web developer. I am a junior programmer with good
            knowledge of front-end-techniques. I love structure and other and I
            also stand for quality. I love spending time on fixing little
            details and optimizing web apps. Also I like working in a team. As
        ...
        <div className="col-lg-6 imgabout">
          <img
            className="img-fluid "
            src="https://i.ibb.co/dDhpTps/20181001-141325-removebg-preview.png"
            alt=""
          />
        </div>
      </div> */}
